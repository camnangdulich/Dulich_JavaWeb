		...
		<div class="container">
			<div class="row justify-content-md-center">
				<div class="col-md-10 col-md-auto">
					<form action="admin/sloaibv.html" method="post">
						<input name="idloaibv" type="hidden" value="${loai.idloaitin}">
						<div class="form-group row">
							<label class="col-sm-2 col-form-label">Loại bài viết</label>
							<div class="col-sm-10">
								<input name="tenloaibv" type="text" class="form-control" placeholder="Nhập tên quyền" value="${loai.loaitin}">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input name="mota" type="text" class="form-control"
									placeholder="Mô tả loại bài" value="${loai.mota }">${message}
							</div>
						</div>
						<div class="form-group row">
