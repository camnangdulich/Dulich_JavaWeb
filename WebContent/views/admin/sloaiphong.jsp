        ...
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="col-md-10 col-md-auto">
                    <form action="admin/sloaiphong.html" method="post" enctype="multipart/form-data" id="sualp">
                    	...
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <a onclick="document.getElementById('my_file').click();" style="cursor: pointer;">
                                	<img id="myimage" src="files/phong/${lstlp.hinhanh}" style="max-width: 120px; max-height: 120px;">
                                </a>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10" id="label-validation">
                                <input name="gia" type="text" class="form-control" value="${lstlp.gia}" placeholder="Sửa giá">
                            </div>
                        </div>
                        <div class="form-group row">
