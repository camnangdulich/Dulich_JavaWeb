            ...
            <div class="card my-4">
                ...
                <div class="card-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group row">
                            <label class="col-4 col-form-label">Số giường phụ</label>
                            <div class="col-8">
                        ...
                        <div class="col-md-12">
                            <div class="form-check">
                                <label class="custom-control custom-checkbox">
                                    ...
                                    <span class="custom-control-description">Tôi đã đọc và chấp nhận các chính sách của khách sạn, điều khoản, điều kiện
                                        và chính sách quyền riêng tư</span>
                                </label>
                            </div>
        ...
        <div class="col-lg-6">
            <div class="card my-4">
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6 ih-item square effect7" style="height: 100%; padding: 0;">
                                <a href="#">
                                    <div class="img"><img class="img-fluid rounded" src="http://placehold.it/700x450" alt=""></div>
                                    <div class="info">
                                        <h3>Heading here</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <hr>
                                    <p><i class="fa fa-location-arrow"></i> Trần Hưng Đạo, Khu Phố 7, Thị Trấn Dương Đông, TP. Phú Quốc</p>
                                    <p><i class="fa fa-phone"></i> 0123456789</p>
                                    <p><i class="fa fa-clock-o"></i> Mở cửa từ: 12:00 AM - 11:30 PM</p>
                                    <p class="p-fx">
                                        Thiết kế đơn giản, thực tế và thanh lịch.<br>
                                        Nội thất hiện đại, đầy đủ tiện nghi.<br>
                                        Đội ngũ phục vụ chu đáo, tận tâm.
                                    </p>
                                </div>
                            </div>
                        </div>
